...
class Ui_Dialog_DimensionsConverter(object):
    def setupUi(self, Dialog_DimensionsConverter):
        ...
        self.doubleSpinBox_LeftSide = QtWidgets.QDoubleSpinBox(self.layoutWidget)
        self.doubleSpinBox_LeftSide.setObjectName("doubleSpinBox_LeftSide")
        self.horizontalLayout.addWidget(self.doubleSpinBox_LeftSide)
        ...
        self.doubleSpinBox_TopSide = QtWidgets.QDoubleSpinBox(self.layoutWidget)
        self.doubleSpinBox_TopSide.setObjectName("doubleSpinBox_TopSide")
        self.horizontalLayout_2.addWidget(self.doubleSpinBox_TopSide)
        ...
        self.doubleSpinBox_RightSide = QtWidgets.QDoubleSpinBox(self.layoutWidget)
        self.doubleSpinBox_RightSide.setObjectName("doubleSpinBox_RightSide")
        self.horizontalLayout_4.addWidget(self.doubleSpinBox_RightSide)
        ...
        self.doubleSpinBox_BottomSide = QtWidgets.QDoubleSpinBox(self.layoutWidget)
        self.doubleSpinBox_BottomSide.setObjectName("doubleSpinBox_BottomSide")
        self.horizontalLayout_5.addWidget(self.doubleSpinBox_BottomSide)
    ...
    def retranslateUi(self, Dialog_DimensionsConverter):
        ...
        self.label.setText(_translate("Dialog_DimensionsConverter", "Please click on each corner of the robot\'s playing area. Start with the bottom left corner, and proceed in a clockwise manner. Please also indicate the lengths of each side (default values correspond to the CADs provided on the git repository). When you are done, press Ok. If you wish to start again, press the Retry button. "))
        self.label_2.setText(_translate("Dialog_DimensionsConverter", "Left side"))
        self.label_3.setText(_translate("Dialog_DimensionsConverter", "meters"))
        self.label_4.setText(_translate("Dialog_DimensionsConverter", "Top side"))
        self.label_5.setText(_translate("Dialog_DimensionsConverter", "meters"))
        self.label_8.setText(_translate("Dialog_DimensionsConverter", "Right side"))
        self.label_9.setText(_translate("Dialog_DimensionsConverter", "meters"))
        self.label_10.setText(_translate("Dialog_DimensionsConverter", "Bottom side"))
        self.label_11.setText(_translate("Dialog_DimensionsConverter", "meters"))
