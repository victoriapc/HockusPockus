...
class HSVConfigSubscriber:
    def __init__(self,i_config):
        ...
        self.m_config = i_config
        self.defaultHValue = i_config.GetHValue()
        self.defaultSValue = i_config.GetSValue()
        self.defaultVValue = i_config.GetVValue()
    ...
    def resetValues(self,i_reset):
        ...
        """
        if i_reset.data:
            self.m_config.SetHValue(self.defaultHValue)
            self.m_config.SetSValue(self.defaultSValue)
            self.m_config.SetVValue(self.defaultVValue)
